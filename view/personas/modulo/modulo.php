            ...
            <div class="col-sm-9 col-xs-12 vcenter" style="vertical-align:top;">
                ...
                <div class="tab-content p30">
                    <div role="tabpanel" class="tab-pane active" id="info1">
                        <div ng-include src=" 'view/personas/modulo/modulo-descripcion.php' "></div>
                    </div>
                    <div role="tabpanel" class="tab-pane" id="info2">
                        <div ng-include src=" 'view/personas/modulo/modulo-contenido.php' "></div>
                    </div>
                    <div role="tabpanel" class="tab-pane" id="info3">
                        <div ng-include src=" 'view/personas/modulo/modulo-pqrs.php' "></div>
                    </div>
                </div>
            </div>
